...
<p align="center"> 
  <img src="https://skillicons.dev/icons?i=js,ts,c,cpp,html,css,sass,bootstrap,jquery,md,babel,webpack,cloudflare,java,figma,github,githubactions,git,codepen,stackoverflow,firebase,heroku,vercel,mongodb,mysql,sqlite,postgres,sequelize,nodejs,express,react,redux,vite,redis,gcp,svg,vscode,androidstudio,powershell,postman&theme=dark" />
</p>  
